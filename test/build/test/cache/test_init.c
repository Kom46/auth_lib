...

{
   ...
   ((void *)0)
    ...
    do {if (((AUTH_RESULT_OK) != (register_user("bcd", "bcd")))) {} else {UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((UNITY_UINT)(31)));}} while(0);

    do {if ((get_userlist_head() != get_userlist_tail())) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(32)));}} while(0);
